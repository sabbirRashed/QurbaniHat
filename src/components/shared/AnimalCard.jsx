    ...
    return (
        <div className="w-full max-w-sm mx-auto   rounded-2xl overflow-hidden shadow-lg bg-white border border-gray-100 hover:shadow-xl transition-all duration-300  hover:scale-[1.02]">
            ...
            <div className="p-5">
                ...
                <div className="grid grid-cols-2 gap-2 my-4 bg-[var(--color-bg)] p-3 rounded-xl text-sm text-gray-600">
                ...
                <div className="flex items-center justify-between mt-4 pt-2 border-t border-gray-100">
                    ...
                    <Link 
                    href={`/animal-details/${id}`}>
                        <Button className="bg-[var(--color-secondary)] hover:bg-[var(--color-primary)] text-white font-bold  rounded-lg transition-colors duration-300 text-sm">
                            View Details
                        </Button>
                    </Link>
                </div>
